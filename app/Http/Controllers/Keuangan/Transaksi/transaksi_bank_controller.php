    ...
    public function save(Request $request){
    	...
    	if($request->jenis_transaksi == 'BM'){
    		...
    		// Pembukuan Jurnal
                ...
                _initiateJournal_self_detail($bukti, "BM", $request->tanggal_transaksi, $request->keterangan, $acc);
            ...
            // Pembukuan Jurnal
                ...
                _initiateJournal_self_detail($bukti, "BK", $request->tanggal_transaksi, $request->keterangan, $acc);
