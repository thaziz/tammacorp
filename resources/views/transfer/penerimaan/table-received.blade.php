                              ...
                              @foreach($transferItemDt as $data)
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        onkeyup="HitungQtyRecieved('{{$data->i_id}}');cekQty(this, event);" type="text" name="qtyRecieved[]"  readonly class="form-control text-right terima" value="{{$data->tidt_qty_received}}">
                                      </td>
                                    </tr>
                              @endforeach
                           </tbody>
