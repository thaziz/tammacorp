  ...
  <div class="panel-body">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-3 col-xs-12" align="center">
        <button class="btn btn-primary btn-sm btn-flat" type="button" onclick="lihatLemburByTanggal()">
          <strong>
      ...
      <div align="right">
        <button type="button" class="btn btn-box-tool" title="Tambahkan Data Item" data-toggle="modal" data-target="#modal_tambah_data">
          ...
          <table class="table tabelan table-hover table-bordered" width="100%" cellspacing="0" id="tbl-index">
            <thead>
              <tr>
                ...
                <th class="wd-15p">Pegawai</th>
                <th class="wd-20p">Nama</th>
                <th class="wd-15p">Keperluan</th>
