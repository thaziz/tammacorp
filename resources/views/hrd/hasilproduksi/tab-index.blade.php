  ...
  <div class="panel-body">
    <div class="row">
      ...
      <div class="col-md-2 col-sm-3 col-xs-12">
        <label class="tebal">Tanggal Hasil Pekerjaan</label>
      </div>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12" align="center">
        <button class="btn btn-primary btn-sm btn-flat" type="button" onclick="lihatHasilByTanggal()">
          <strong>
