  ...
  <div class="modal-dialog" style="width: 50%;margin: auto;">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: #e77c38;">
        ...
        <h4 class="modal-title" style="color: white;">Detail Penerimaan Retur Supplier
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-top:10px;padding-bottom: 10px;padding-top: 20px;margin-bottom: 15px;">
          <div class="col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 10px;">
            <div class="col-md-2 col-sm-2 col-xs-12">
              <label class="tebal">Kode Retur</label>
            </div>

            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label id="lblHeadRetur"></label>
              </div>  
            </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;">
            <div class="col-md-2 col-sm-2 col-xs-12">
              <label class="tebal">Tgl Retur</label>
            </div>

            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label id="lblHeadTglRetur"></label>
              </div>  
            </div>
