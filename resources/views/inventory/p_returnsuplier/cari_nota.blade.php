            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
                        ...
                        <li class="active">Penerimaan Barang Return Customer</li><li><i class="fa fa-angle-right"></i>&nbsp;Cari Nomor Nota&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6" align="right">
                                  <a href="{{ url('/inventory/p_returncustomer/cust') }}" class="btn btn-box-tool"><i class="fa fa-arrow-left"></i></a>
                                </div>
                              </div>
