  ...
  <div id="page-wrapper">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
      ...
      <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
        <div class="page-title">Tambah Stock Opname
        </div>
      </div>
              ...
              <div id="tab-general">
                <div class="row mbl">
                  <div class="col-lg-12">
                    ...
                    <ul id="generalTab" class="nav nav-tabs responsive"></ul>
                          ...
                          <div class="col-md-12">
                            <form method="post">
                              <div class="col-md-5" style="margin-bottom: 20px; padding-bottom:5px; ">
                                ...
                                <div class="form-group">
                                  <input type="submit" name="tambah_data" value="Tambah Data" class="btn btn-primary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ url('inventory/stockopname/opname') }}" class="btn btn-danger">Kembali</a>
                                </div>
                              </div>
                            </form>
                          </div>                                       
