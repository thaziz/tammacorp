<div id="index-tab" class="tab-pane fade in active">
  <div class="panel-body">
    ...
    <div class="col-md-3 col-sm-3 col-xs-12" align="center">
      <button class="btn btn-primary btn-sm btn-flat" type="button" onclick="lihatBrgRusakByTanggal()">
        <strong>
    ...
    <div align="right">
      <button type="button" class="btn btn-box-tool" title="Tambahkan Data Pemakaian" data-toggle="modal" data-target="#modal_barang_rusak">
