                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="padding-bottom: 5px;padding-top: 20px;margin-bottom: 15px;">
                                    ...
                                    <div class="col-md-3 col-sm-8 col-xs-12">
                                        <div class="form-group">
                                            <input id="id-group" type="hidden" class="form-control input-sm" name="id" value="{{$group->g_id}}">
                                    ...
                                    <div class="col-md-3 col-sm-8 col-xs-12">
                                            <div class="form-group">
                                                <button type="button" id="button_save" class="btn btn-primary" onclick="perbaruiGroup()">Perbarui Data</button> 
                                            </div>
                                    </div>
                                      ...
                                      <tbody>
                                        ...
                                        @if($data->a_parrent==0)                                        
                                            <tr style="background: #f7e8e8">    
                                                ...
                                                <td>         
                                                 <input type="hidden" @if($data->ga_read=='Y')  value="Y" @else 
                                                 value="N" @endif name="view[]"  id="view-{{$data->a_id}}">       
                                                <input type="checkbox" class="checkbox ds" onchange="simpanView('{{$data->a_id}}')"  id="view1-{{$data->a_id}}" 
                                            ...
                                            <tr>    
                                                ...
                                                <input type="checkbox" class="checkbox ds" onchange="simpanView('{{$data->a_id}}')"  id="view1-{{$data->a_id}}" @if($data->ga_read=='Y') checked="" @endif>
                                                ...
                                                <td class="text-center">
                                                    <input type="checkbox" class="checkbox ds" onchange="simpanInsert('{{$data->a_id}}')" id="insert1-{{$data->a_id}}"
                                                    @if($data->ga_insert=='Y') checked="" @endif>

                                                    <input type="hidden" @if($data->ga_insert=='Y')  value="Y" @else 
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @if($data->ga_update=='Y') checked="" @endif>
                                                     ...
                                                     <input type="hidden" @if($data->ga_update=='Y')  value="Y" @else 
                                                 value="N" @endif name="update[]"  id="update-{{$data->a_id}}">

                                                </td>
                                                <td class="text-center">
                                                    <input type="checkbox" class="checkbox ds"  onchange="simpanDelete('{{$data->a_id}}')" id="delete1-{{$data->a_id}}"
                                                    @if($data->ga_delete=='Y') checked="" @endif>

                                                     <input type="hidden" @if($data->ga_delete=='Y')  value="Y" @else 
                                                 value="N" @endif  id="delete-{{$data->a_id}}" name="delete[]" >

                                                </td>
                                                <td class="text-center">
                                                    <input type="checkbox" class="checkbox ds" name="laporan[]" onchange="simpanLaporan('{{$data->a_id}}')" id="laporan-{{$data->a_id}}">
                                                </td>
                                                <td class="text-center">
                                                    <input type="checkbox" class="checkbox ds" name="Unlock[]" onchange="simpanUnlock('{{$data->a_id}}')" value="1" id="Unlock-{{$data->a_id}}">
                                                    <input type="hidden" name="status[]" id="status-{{$data->a_id}}" value="0">  
                                                </td>
                                            </tr>
                                            @endif
