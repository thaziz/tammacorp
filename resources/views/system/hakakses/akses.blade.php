                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div align="right" style="margin-bottom: 10px;">
                                            <a href="{{url('/system/hakakses/tambah-akses-group')}}"
                                               class="btn btn-primary btn-flat btn-sm"><i class="fa fa-plus"></i>&nbsp;Tambah
                                                Data</a>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-warning btn-sm" title="Edit"
                                                                    onclick="editAksesGroup('{{$value->g_id}}')"><i
                                                                        class="fa fa-pencil"></i></button>
                                                            <button class="btn btn-danger btn-sm" title="Hapus"><i
                                                                        class="fa fa-trash-o"
                                                                        onclick="hapusAksesGroup('{{$value->g_id}}')"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                                @endforeach
