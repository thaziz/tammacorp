                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12"
                                        ...
                                        <form id="data-user">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg"
                                                ...
                                                <div class="col-md-3 col-sm-8 col-xs-12">
                                                    <div class="form-group">
                                                        <input id="m_id" type="hidden"
                                                               class="form-control input-sm disable" name="m_id"
                                                               value="{{$mem->m_id}}">
                                                ...
                                                <div class="col-md-3 col-sm-8 col-xs-12">
                                                    <div class="form-group">
                                                        <input type="Password" class="form-control input-sm disable"
                                                               name="Password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-9 col-sm-8 col-xs-12">
                                                    <div class="form-group">
                                                        <textarea name="alamat" class="form-control disable"
                                                                  value="{{$mem->m_addr}}"></textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach($mem_access as $index => $data)
                                                        ...
                                                        @if($data->a_parrent==0)
                                                            <tr style="background: #f7e8e8">
                                                                ...
                                                                <td>
                                                                    <input type="hidden"
                                                                           @if($data->ma_read=='Y')  value="Y" @else
                                                                           value="N" @endif class="checkbox"
                                                        ...
                                                        @else
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <input type="hidden"
                                                                           @if($data->ma_insert=='Y')  value="Y" @else
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <input type="hidden"
                                                                           @if($data->ma_update=='Y')  value="Y" @else
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <input type="hidden"
                                                                           @if($data->ma_delete=='Y')  value="Y"
                                                                           @else value="N" @endif  name="delete[]"
                                                                           id="delete-{{$data->a_id}}">
