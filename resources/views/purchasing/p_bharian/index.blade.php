...
<div id="page-wrapper">
  ...
  <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
        <div class="page-title">Penerimaan Belanja Harian</div>
    </div>

    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
      <li><i class="fa fa-home"></i>&nbsp;<a href="{{ url('/home') }}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
      <li><i></i>&nbsp;Inventory&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
      <li class="active">Penerimaan Belanja Harian</li>
    </ol>
      ...
      <div class="row mbl">
        <div class="col-lg-12">
          ...
          <div id="generalTabContent" class="tab-content responsive">
            ...
            @include('purchasing.p_bharian.tab-index')
  ...
  <!-- modal -->
    <!--modal Tambah Terima-->
    @include('purchasing.p_bharian.modal')
    @include('purchasing.p_bharian.modal-detail')
    @include('purchasing.p_bharian.modal-detail-peritem')
  <!-- /modal -->
</div>
@endsection
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    //select2
    $( "#head_nota_belanja" ).select2({
      placeholder: "Pilih Nota Pembelian...",
      ajax: {
        url: baseUrl + '/purchasing/p_belanjaharian/lookup-data-pembelian',
        dataType: 'json',
    ...
    $('#head_nota_belanja').change(function() 
    {
      $('#appending div').remove();
      $('#btn_simpan').attr('disabled', false);
      //remove existing appending row
      $('tr').remove('.tbl_form_row');
      var idNota = $('#head_nota_belanja').val();
      $.ajax({
        url : baseUrl + "/purchasing/p_belanjaharian/get-data-form/"+idNota,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          var totalPembelianNett = data.data_header[0].d_pcsh_totalprice;
          $('#head_nota_txt').val($('#head_nota_belanja').text());
          $('#head_supplier').val(data.data_header[0].s_company);
          $('#head_supplier_id').val(data.data_header[0].s_id);
          $('#head_total_raw').val(totalPembelianNett);
          $('#head_total').val(convertDecimalToRupiah(totalPembelianNett));
          $('#head_total_terima_raw').val(totalPembelianNett);
          ...
          Object.keys(data.data_isi).forEach(function(){
            var hargaItem = data.data_isi[key-1].d_pcshdt_price;
            var hargaTotalItem = data.data_isi[key-1].d_pcshdt_pricetotal;
            var qty = data.data_isi[key-1].d_pcshdt_qtyconfirm;
            var qtyTerima = data.data_qty[key-1];
            var hargaTotalPerRow = hargaItem * qtyTerima;
            ...
            $('#tabel-modal-terima').append('<tr class="tbl_form_row" id="row'+i+'">'
                            ...
                            +'<input type="hidden" value="'+data.data_isi[key-1].d_pcshdt_id+'" name="fieldIdPharianDet[]" class="form-control input-sm"/></td>'
                            +'<td><input type="text" value="'+qty+'" name="fieldQty[]" class="form-control numberinput input-sm field_qty" readonly/></td>'
                            ...
                            +'<td><input type="text" value="'+convertDecimalToRupiah(hargaItem)+'" name="fieldHarga[]" id="cost_'+i+'" class="form-control input-sm field_harga numberinput" readonly/>'
                            +'<input type="hidden" value="'+hargaItem+'" name="fieldHargaRaw[]" id="costRaw_'+i+'" class="form-control input-sm field_harga_raw numberinput" readonly/></td>'
    ...
    $('#head_nota_belanja').change(function(event) {
      if($(this).val() != ""){
  ...
  function submitTerima() {
    iziToast.question({
      ...
      displayMode: 'once',
      //zindex: 999,
      title: 'Terima data belanja harian',
        ...
        ['<button><b>Ya</b></button>', function (instance, toast) {
          ...
          if(IsValid)
          {
            ...
            if(countRow > 0)
            {
              ...
              $('#btn_simpan').attr('disabled',true);
              $.ajax({
                url : baseUrl + "/purchasing/p_belanjaharian/simpan-penerimaan",
                type: "POST",
                dataType: "JSON",
