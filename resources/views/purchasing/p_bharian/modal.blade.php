    ...
    <form method="post" id="form-terima-beli" name="formTerimaBeli">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #e77c38;">
          ...
          <h4 class="modal-title" style="color: white;">Tambah Penerimaan Belanja Harian</h4>
        </div>
        ...
        <div class="modal-body">
          <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-top:10px;padding-bottom: 10px;padding-top: 20px;margin-bottom: 15px;">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12">
              <label class="tebal">Nota Belanja Harian (PO)</label>
            </div>

            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="form-group" id="divSelectNota">
                <select class="form-control input-sm select2" id="head_nota_belanja" name="headNotaBelanja" style="width: 100% !important;">
                </select>
            ...
            <div class="col-md-2 col-sm-12 col-xs-12">
              <label class="tebal">Harga Total</label>
            </div>

            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="form-group">
                <input type="text" name="headTotal" id="head_total" readonly="" class="form-control input-sm">
                <input type="hidden" name="headTotalRaw" id="head_total_raw" readonly="" class="form-control input-sm">
              </div>
            </div>

            <div class="col-md-2 col-sm-12 col-xs-12">
              <label class="tebal">Harga Total Penerimaan</label>
            </div>

            <div class="col-md-4 col-sm-12 col-xs-12">
              <div class="form-group">
                <input type="text" name="headTotalTerima" id="head_total_terima" readonly="" class="form-control input-sm">
                <input type="hidden" name="headTotalTerimaRaw" id="head_total_terima_raw" readonly="" class="form-control input-sm">
              </div>
            </div>
