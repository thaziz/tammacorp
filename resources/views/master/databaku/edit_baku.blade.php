                    ...
                    <div id="tab-general">
                        ...
                        <div id="generalTabContent" class="tab-content responsive">
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12 " style="margin-top:15px;">
                            <form id="form-save">
                              <input type="hidden" name="code_old" value="{{ $data->bb_code }}">
                              <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-bottom: 20px; padding-bottom:5px;padding-top:15px;padding-left:-10px;padding-right: -10px; ">
                                ...
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" id="id_bb" name="id_bb" readonly="" value="{{ $data->bb_code }}" class="form-control input-sm">                                  
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" id="nama" name="nama" value="{{ $data->bb_name }}" class="form-control input-sm">                               
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" name="jumlah" id="jumlah" value="{{ $data->bb_total }}" class="form-control input-sm">
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" name="satuan" id="satuan" value="{{ $data->bb_unit }}" class="form-control input-sm">
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" name="harga" id="harga" value="{{ $data->bb_price }}" class="form-control input-sm">
                                  </div>
                                </div>
