            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
                        <div class="page-title">Form Data Edit Transaksi Keuangan</div>
                    </div>
                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <ul id="generalTab" class="nav nav-tabs">
                              <li class="active"><a href="#alert-tab" data-toggle="tab">Form Data Edit Transaksi Keuangan</a></li>
                        ...
                        <div id="generalTabContent" class="tab-content responsive">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:-10px;margin-bottom: 15px;"> 
                           <div class="col-md-5 col-sm-6 col-xs-8">
                             <h4>Form Data Edit Transaksi Keuangan</h4>
                           </div>
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-top:15px;margin-bottom: 15px; padding-bottom:5px;padding-top: 15px; ">
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <input type="text" class="form-control form_validate" name="nomor_transaksi" placeholder="Masukkan Nomor Transaksi" readonly>                                  
                                  </div>
                                </div> 
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <input type="text" class="form-control form_validate" name="tanggal_transaksi" placeholder="Pilih Tanggal Transaksi" value="{{ date("d-m-Y", strtotime($transaksi->tanggal_transaksi)) }}" readonly>                                  
                                  </div>
                                </div>  
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <input type="text" class="form-control form_validate" name="nama_transaksi" placeholder="Masukkan Nama Transaksi" value="{{$transaksi->nama_transaksi}}">                        
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <?php
                                      $ocf = $icf = $fcf = "";
                                      if($transaksi->cash_type == "OCF")
                                        $ocf = "selected";
                                      elseif($transaksi->cash_type == "ICF")
                                        $icf = "selected";
                                      elseif($transaksi->cash_type == "FCF")
                                        $fcf = "selected";
                                    ?>
                                    <select class="form-control" id="cashtype" name="Cash Type">                       
                                      <option value="OCF" {{$ocf}}>Operating Cash Flow</option>                                    
                                      <option value="FCF" {{$fcf}}>Financing Cash Flow</option>                                    
                                      <option value="ICF" {{$icf}}>Investing Cash Flow</option>
                                    </select>                                  
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <textarea class="form-control form_validate" id="Keterangan" name="Keterangan" placeholder="Tulis Keterangan" rows="5" style="resize: none;">{{$transaksi->keterangan}}</textarea>
                                  </div>
                                </div>
                              </div>
