            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
                        ...
                        <li class="active">Edit Data Transaksi Keuangan</li><li><i class="fa fa-angle-right"></i>&nbsp;Form Data Transaksi Keuangan&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <ul id="generalTab" class="nav nav-tabs">
                              <li class="active"><a href="#alert-tab" data-toggle="tab">Edit Data Transaksi Keuangan</a></li>
                        ...
                        <div id="generalTabContent" class="tab-content responsive">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:-10px;margin-bottom: 15px;">
                           <div class="col-md-5 col-sm-6 col-xs-8">
                             <h4>Edit Data Transaksi Keuangan</h4>
                           </div>
