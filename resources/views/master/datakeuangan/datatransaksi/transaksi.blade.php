              ...
              <div id="alert-tab" class="tab-pane fade in active">
                <div class="row" style="margin-top:-20px;">
                  <div align="right" class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:10px;">
                    <a href="{{ url('master/keuangan/master_transaksi/add') }}">
                      ...
                      <table class="table tabelan table-hover table-responsive table-bordered" width="100%" cellspacing="0" id="tbl_customer">
                        <thead>
                          <tr>
                            ...
                            <th class="wd-15p text-center">Id Transaksi</th>
                            <th class="wd-15p text-center">Nama Transaksi</th>
                            <th class="wd-15p text-center">Type Transaksi</th>
                            <th class="wd-15p text-center">Type Cashflow</th>
...
@section("extra_scripts")
  ...
  $('#tbl_customer').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:'{{ route('master_transaksi.get_transaksi') }}',
            },
             columnDefs: [
        ...
        function edit(a) {
            window.location = '{{ url('/') }}/master/keuangan/master_transaksi/edit?id='+a;
        }
