            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
                        ...
                        <li class="active">Edit Data Pegawai</li><li><i class="fa fa-angle-right"></i>&nbsp;Form Edit Data Pegawai&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <ul id="generalTab" class="nav nav-tabs">
                              <li class="active"><a href="#alert-tab" data-toggle="tab">Form Edit Data Pegawai</a></li>
