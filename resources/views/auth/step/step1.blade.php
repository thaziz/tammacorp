...
<head>
    ...
    <title>DBoard | Reset Password </title>
...
<body class="gray-bg">
   <div class="loginColumns animated fadeInDown" style="margin-top: -50px;">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="col-md-12 text-center" style="color: #555; margin-bottom: 20px; font-size: 12px;">
                    <div>
                        <span style="padding: 10px; border-radius: 5px; background: #23c6c8; color: #fff">1</span>
                    </div>
                    <br/>
                    Keamanan Password
                </div>
                ...
                <div class="ibox-content">
                    ...
                    <div class="row" style="padding:10px 20px 10px 10px;">
                        <quote><strong>{{ Auth::user()->m_name }}</strong>, Password yang anda miliki sekarang adalah password default dari aplikasi DBoard. Untuk keamanan, sebaiknya anda membuat password baru dengan cara mengisi field dibawah ini.</quote>
                    </div>
                    <div class="row">
                        <form class="m-t" role="form" id="email-form">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="password" class="form-control col-md-6" placeholder="Masukkan Password Baru" name="m_password_baru" id="m_password_baru">
                                <span class="help-block m-b-none" style="margin-bottom: 10px; padding-left: 10px; color: #ed5565; visibility: hidden;" id="password_baru_error"><small>.</small></span>

                                <input required type="password" class="form-control" placeholder="Masukkan Password Lama" name="m_password_lama" id="m_password_lama">
                                <span class="help-block m-b-none" style="padding-left: 10px; color: #ed5565; visibility: hidden;" id="password_lama_error"><small>.</small></span>
                            ...
                            <div class="col-md-8 no-padding">
                                <button type="button" class="ladda-button ladda-button-demo btn btn-primary block full-width m-b" data-style="zoom-in">Konfirmasi Password</button>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function validation(){
            var me_email_lama = document.getElementById('m_password_lama');
            var me_email_baru = document.getElementById('m_password_baru');
            ...
            //     return false;
            // }
            if(me_email_baru.validity.valueMissing){
                $('#password_baru_error').css('visibility', 'visible');
                $('#password_baru_error small').text('* Password Baru Tidak Boleh Kosong');
                return false;
            }else if(me_email_lama.validity.valueMissing){
                $('#password_lama_error').css('visibility', 'visible');
                $('#password_lama_error small').text('* Password Lama Tidak Boleh Kosong');
                return false;
            }
