...
<div class="col-md-4 col-sm-6 col-xs-12">
    <div class="form-group">
        <div class="input-daterange input-group">
            <input id="Rtgl1" class="form-control input-sm datepicker1 " name="tanggal" type="text"
                   value="{{ date('d-m-Y', strtotime(date('d-m-Y').' - 2 days')) }}">
            <span class="input-group-addon">-</span>
            <input id="Rtgl2" class="input-sm form-control datepicker2" name="tanggal" type="text"
                   value="{{ date('d-m-Y') }}">
        </div>
    </div>
</div>
