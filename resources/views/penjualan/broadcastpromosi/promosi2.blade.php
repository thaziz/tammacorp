                                ...
                                <div id="alert-tab" class="tab-pane fade in active">
                                  ...
                                  <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                     ...
                                     <div align="right">
                                       <a class="btn btn-box-tool" href="{{url('penjualan/broadcastpromosi/tambah_promosi2')}}"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Broadcast</a>
                                     </div>
                                     <div class="table-responsive" style="margin-top: 20px;">
                                       <table class="table tabelan table-bordered table-hover" id="data">
                                         ...
                                         <tbody>
                                           <tr>
                                             <td>06-02-2018 23:59:59</td>
                                             <td>alpha@alpha.com, bravo@bravo.com, charlie@charlie.com</td>
                                             <td>
